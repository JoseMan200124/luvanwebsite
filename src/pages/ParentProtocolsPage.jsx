// src/pages/ParentProtocolsPage.jsx
...
const ParentProtocolsPage = () => {
  ...
  const fetchProtocols = async () => {
    ...
    try {
      ...
      console.error('[ParentProtocols] fetch error', e);
      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 2 }}>
          <Box>
            ...
            <Typography variant="body2" color="text.secondary">Consulta documentos disponibles para tu colegio</Typography>
          </Box>
          ...
          <CardContent>
            {isSuspended ? (
              <Alert severity="warning">
                Tu cuenta está suspendida. Para acceder a Protocolos y Reglamentos debes firmar el contrato y/o completar el proceso de pago.
              </Alert>
            ) : (
              <>
                <Tabs
...
export default ParentProtocolsPage;
